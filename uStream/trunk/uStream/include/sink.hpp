...
namespace uStreamLib {
	 ...
	 * A sink is a specialized Block which consumes data
	 * as its main task.
	 */
	class US_EXPORT Sink : public Block {
	public:
		/* friend classes */
		...
		/**
				 * Redefined method to signal this is a Sink.
				 * @return Block::TYPE_SINK.
				 */
		int32 getType(void)
		{
			return Block::TYPE_SINK;
	...
	protected:
		/**
			 * Build a sink. A sink inherits from Block.
			 * @param bm a pointer to the block manager.
			 * @param name a descriptive name of this sink.
